...
public class EmbProcessImage {
    ...
    public String emb(String s, String s1)
    {
        try{
            ...
            FileOutputStream fileoutputstream = new FileOutputStream(Environment.getExternalStorageDirectory().getPath()+"/temp.mp4");
            ...
            file.delete();
           // File file2 = new File(Environment.getExternalStorageDirectory().getPath()+"/temp.mp4");
            //file2.renameTo(file);
